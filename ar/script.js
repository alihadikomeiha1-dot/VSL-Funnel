...
const videos = [
  { yt: 'FeKmsaKkG7o', name: 'د. مريم', role: 'طبيبة أسنان', country: 'طرابلس، لبنان', flag: '🇱🇧', result: 'عزّزت علامتها الشخصية وحضورها الرقمي عبر محتوى استراتيجي' },
  ...
  { yt: 'yOzWALWUTGI', name: 'مريم عيّاش', role: 'دكتوراه في الكيمياء الحيوية', country: 'لبنان', flag: '🇱🇧', result: 'انطلقت من الصفر إلى قرابة 500,000 متابع' },
  { yt: 'OTY1BiaYH_I', name: 'د. علي مغنية', role: 'طبيب وريادي أعمال', country: 'لبنان', flag: '🇱🇧', result: 'انطلق من الصفر إلى 110,000 متابع وبنى علامة ONAD الناجحة' },
  { yt: 'Q2ia-DrBbCk', name: 'شيرين البوبو', role: 'مؤسِّسة Synthe Label', country: 'لبنان', flag: '🇱🇧', result: 'حقّقت 12,000 متابع خلال 3 أشهر تقريباً' },
  { yt: 'rxw_T8n-hL8', name: 'نور البوبو', role: 'مؤسِّسة علامة هدايا تذكارية', country: 'لبنان', flag: '🇱🇧', result: 'بنَت علامة تذكارية معروفة عبر نظام المحتوى في Film Levant' },
  { yt: 'me_10Nio1g8', name: 'وفاء', role: 'صيدلانية', country: 'لبنان', flag: '🇱🇧', result: 'انطلقت من الصفر إلى قرابة 250,000 متابع وأسّست مشروعين ناجحين' },
];
...
set('video-list', videos.map((v) => `
  <article class="vcard" ${v.yt ? `data-video="${esc(v.yt)}"` : `data-src="${esc(v.src)}"`} role="button" tabindex="0" aria-label="شاهد شهادة ${esc(v.name)}">
    <div class="vcard__thumb">
      ${v.yt
        ? `<img class="vcard__video" src="https://i.ytimg.com/vi/${esc(v.yt)}/hqdefault.jpg" alt="شهادة ${esc(v.name)}" loading="lazy">`
...
(function () {
  ...
  function open(card) {
    ...
    lb.querySelector('.vlb__frame').innerHTML = yt
      ? '<iframe src="https://www.youtube.com/embed/' + yt + '?autoplay=1&rel=0&playsinline=1" title="شهادة فيديو" ' +
